...
export default function MeseroModuleScreen() {
        ...
        <View style={styles.topBar}>
          ...
          <View style={styles.topInfo}>
            <Text style={styles.topTitle}>
              {mesaSeleccionada.nombre} — PEDIDO
            </Text>
            <Text style={styles.topSub}>Diana Dorado · Cap. {mesaSeleccionada.capacidad} personas</Text>
          </View>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.topBar}>
        ...
        <View style={styles.topInfo}>
          <Text style={styles.topTitle}>MÓDULO MESERO</Text>
          <Text style={styles.topSub}>Diana Dorado · Turno activo</Text>
        </View>

        <View style={styles.statusPill}>
          <Text style={styles.statusPillText}>8 mesas</Text>
        </View>
      </View>
